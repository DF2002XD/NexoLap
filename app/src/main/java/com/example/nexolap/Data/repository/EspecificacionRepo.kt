...
class EspecificacionRepo : IEspecificacionRepo {
        ...
        var specs = ArrayList(
            listOf(
                ...
                EspecificacionDTO(
                    "0",
                    "Procesador",
                    "Chip M2 de Apple con CPU de 8 núcleos and GPU de 8 núcleos"
                ),
                EspecificacionDTO(
                    "1",
                    "Memoria RAM",
    ...
    override fun readAll(onSuccess: (List<EspecificacionDTO>) -> Unit, onError: () -> Unit) {
        onSuccess(specs)
    }
